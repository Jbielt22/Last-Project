      ...
      >
        ...
        <div className="h-16 px-6 flex items-center justify-between border-b border-gray-800/60">
          <Link href="/admin" className="flex items-center gap-2">
            <span className="w-8 h-8 rounded-lg bg-linear-to-tr from-indigo-500 to-violet-500 flex items-center justify-center text-white font-bold">
              MP
            </span>
            <div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive
                    ? "bg-linear-to-r from-indigo-500/20 to-violet-500/20 text-indigo-300 border border-indigo-500/30 shadow-sm"
        ...
        <div className="p-4 border-t border-gray-800/60">
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl text-xs font-semibold bg-gray-800/60 hover:bg-gray-800 text-gray-300 hover:text-white transition-all border border-gray-700/50"
          >
            <span>🌐</span>
