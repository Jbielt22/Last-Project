      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Kombinasi keahlian teknis dan perkakas bantu yang saya gunakan untuk mewujudkan konsep menjadi website yang fungsional.
          </p>
        </div>
                    ...
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i}>
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <div className="h-4 bg-gray-800 rounded w-1/12" />
                        </div>
            ...
            : skillGroupsList.map((group) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-800/50">
                    <span className="text-3xl">{group.icons || "💻"}</span>
